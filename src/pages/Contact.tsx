              ...
              <div className="space-y-5 text-sm">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919352392905" className="text-white hover:text-[#FFD500] font-medium mt-1 block">
                      +91 93523 92905
                    </a>
                    <a href="https://wa.me/919352392905" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-[#25D366] text-xs font-semibold mt-1 hover:underline">
