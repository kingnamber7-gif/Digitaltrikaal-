            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="https://wa.me/916350131379" target="_blank" rel="noopener noreferrer" className="block hover:text-[#FFD500] text-xs text-[#25D366] mt-0.5 transition-colors font-medium">
